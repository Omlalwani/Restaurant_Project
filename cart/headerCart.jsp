...
<body>
<%ArrayList<CartModel> cartlist1 = (ArrayList<CartModel>) session.getAttribute("cart-list"); %>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item active"><a href="order.jsp"
						class="nav-link">Order<span class="badge badge-danger"><%= cartlist1.size() %></span></a></li>
